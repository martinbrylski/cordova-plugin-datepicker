...
public class DatePickerPlugin extends CordovaPlugin {
	...
	public synchronized void show(final JSONArray data, final CallbackContext callbackContext) {
		...
		final boolean is24Hour = is24HourView;
		...
		if (ACTION_TIME.equalsIgnoreCase(action)) {
			runnable = new Runnable() {
				...
				public void run() {
					...
					final TimePickerDialog timeDialog = new TimePickerDialog(currentCtx, TimePickerDialog.THEME_DEVICE_DEFAULT_LIGHT, timeSetListener, mHour,
							mMinutes, is24Hour);
